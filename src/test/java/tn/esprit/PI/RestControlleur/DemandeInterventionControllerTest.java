...
class DemandeInterventionControllerTest {
    ...
    @Test
    void testCreateIntervention_Preventive_Success() throws Exception {
        Map<String, Object> request = new HashMap<>();
        request.put("type_demande", "PREVENTIVE");
        request.put("demandeurId", 1L);
        request.put("description", "Maintenance préventive");
        request.put("priorite", "MOYENNE");
        request.put("statut", "EN_ATTENTE");
        request.put("frequence", "MENSUELLE");
        request.put("prochainRDV", "2024-12-01");

        Preventive preventive = new Preventive();
        preventive.setId(2L);
        preventive.setDescription("Maintenance préventive");

        when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
        when(demandeInterventionRepository.save(any(Preventive.class))).thenReturn(preventive);
    ...
    @Test
    void testCreateIntervention_CurativeWithTesteur_Success() throws Exception {
        Map<String, Object> request = new HashMap<>();
        request.put("type_demande", "CURATIVE");
        request.put("demandeurId", 1L);
        request.put("description", "Réparation urgente");
        request.put("priorite", "HAUTE");
        request.put("statut", "EN_ATTENTE");
        request.put("panne", "Panne électrique");
        request.put("urgence", true);
        request.put("testeurCodeGmao", "TEST001");

        Curative curative = new Curative();
        curative.setId(3L);
        curative.setDescription("Réparation urgente");

        tn.esprit.PI.entity.Testeur testeur = new tn.esprit.PI.entity.Testeur();
        testeur.setCodeGMAO("TEST001");

        when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
        when(testeurRepository.findById("TEST001")).thenReturn(Optional.of(testeur));
        when(demandeInterventionRepository.save(any(Curative.class))).thenReturn(curative);
    ...
    @Test
    void testCreateIntervention_DemandeurNotFound() throws Exception {
        Map<String, Object> request = new HashMap<>();
        request.put("type_demande", "CURATIVE");
        request.put("demandeurId", 999L);
        request.put("description", "Test");
        request.put("priorite", "HAUTE");
        request.put("statut", "EN_ATTENTE");
        request.put("panne", "Test");
        request.put("urgence", false);
    ...
    @Test
    void testCreateIntervention_CorrectiveType_Success() throws Exception {
        Map<String, Object> request = new HashMap<>();
        request.put("type_demande", "CORRECTIVE");
        request.put("demandeurId", 1L);
        request.put("description", "Action corrective");
        request.put("priorite", "MOYENNE");
        request.put("statut", "EN_ATTENTE");
        request.put("panne", "Défaut mineur");
        request.put("urgence", false);

        Curative curative = new Curative();
        curative.setId(4L);
        curative.setDescription("Action corrective");
    ...
    @Test
    void testAssignTesteurToIntervention_NotFound() throws Exception {
        when(demandeInterventionService.assignTesteurToIntervention(999L, "TEST001"))
                .thenThrow(new RuntimeException("Intervention not found"));

        mockMvc.perform(put("/demandes/assign/999/testeur/TEST001"))
                .andExpect(status().isNotFound());
    }
    ...
    @Test
    void testConfirmerIntervention_NotFound() throws Exception {
        when(demandeInterventionService.confirmerIntervention(999L))
                .thenThrow(new RuntimeException("Intervention not found"));

        mockMvc.perform(put("/demandes/confirmer/999"))
                .andExpect(status().isNotFound());
    }
    ...
    @Test
    void testCreateBonDeTravailForIntervention_BadRequest() throws Exception {
        BonTravailRequest request = new BonTravailRequest();
        request.description = "Test bon";
    ...
    @Test
    void testCreateBonDeTravailForIntervention_InternalServerError() throws Exception {
        BonTravailRequest request = new BonTravailRequest();
        request.description = "Test bon";
    ...
    @Test
    void testGetBonsDeTravailForIntervention_InternalServerError() throws Exception {
        when(bonDeTravailService.getBonsDeTravailByIntervention(1L))
    ...
    @Test
    void testGetAllDemandesShort_InternalServerError() throws Exception {
        when(demandeInterventionService.getAllDemandes())
                .thenThrow(new RuntimeException("Database error"));
    ...
    @Test
    void testCreateIntervention_WithAlternativeTypeField() throws Exception {
        Map<String, Object> request = new HashMap<>();
        request.put("type", "CURATIVE");
        request.put("demandeurId", 1L);
        request.put("description", "Test with alternative field");
        request.put("priorite", "HAUTE");
        request.put("statut", "EN_ATTENTE");
        request.put("panne", "Test panne");
        request.put("urgence", true);

        Curative curative = new Curative();
        curative.setId(5L);
        curative.setDescription("Test with alternative field");
    ...
    @Test
    void testCreateIntervention_WithTypeDemandeCamelCase() throws Exception {
        Map<String, Object> request = new HashMap<>();
        request.put("typeDemande", "PREVENTIVE");
        request.put("demandeurId", 1L);
        request.put("description", "Test camelCase");
        request.put("priorite", "BASSE");
        request.put("statut", "EN_ATTENTE");
        request.put("frequence", "TRIMESTRIELLE");
        request.put("prochainRDV", "2024-12-15");

        Preventive preventive = new Preventive();
        preventive.setId(6L);
        preventive.setDescription("Test camelCase");
